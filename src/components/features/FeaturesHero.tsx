...
const FloatingBadge = ({ icon: Icon, text, delay, left }: any) => {
    return (
        <motion.div
            ...
            style={{ left: `${left}%` }}
        >
            <Icon size={14} className="text-[#09358c]" />
    ...
    <section className="relative h-screen flex flex-col items-center justify-center pt-20 pb-12 overflow-hidden">
      ...
      <Container className="relative z-10 text-center">
        ...
        >
          <motion.div
            ...
            className="luminous-card inline-flex items-center justify-center gap-2 px-4 lg:px-6 py-2 rounded-full border border-[#09358c]/20 bg-white/80 backdrop-blur-md mb-8 lg:mb-10 shadow-xl"
          >
            <Sparkles size={16} className="text-[#09358c] animate-pulse" />
            <span className="text-[10px] lg:text-xs font-black tracking-[0.3em] uppercase text-[#09358c]">
              Transform Your Capabilities
            </span>
          </motion.div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl 4xl:text-8xl font-black text-slate-900 leading-none mb-8 lg:mb-10 tracking-tight">
            All-in-One <br/>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <button className="bg-[#09358c] hover:bg-[#05a0ec] text-white px-8 py-4 rounded-xl font-black text-base lg:text-lg shadow-xl shadow-[#09358c]/10 transition-all hover:scale-105 active:scale-95 text-center">
              Get Started Now
            </button>
      ...
      >
        <Link
          ...
          className="group flex flex-col items-center text-slate-500 hover:text-[#09358c] transition-colors"
        >
